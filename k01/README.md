...
21~24:特定の市町村別人口データを出力する関数

26~33:市町村別人口データをすべて出力する関数

35~44:長崎の市町村データが入っているファイルを開く

65~:リニアサーチで市町村を検索する

70~74:探す値（key)とID(i)が一致するまで繰り返し処理

79~:バイナリサーチで市町村を検索する

83:結果を見つからなかったにしておく

84,85:リストの左端と右端をそれぞれ0とリストの最後のindexにする

89:⽐較対象の位置(i)をリストの真ん中にする

90~99:探す値(key)と⽐較対象の位置の値(i)を⽐較

94~98:探す値の方が大きい場合、探す値の⽅が⼤きい場合、リストの左端を⽐較対象位置の⼀つ右にし、それ以外の場合右端を左にする

111~117:事前準備

120~128:リニアサーチで市町村を検索する

130~137:バイナリサーチで市町村を検索する
