...
79. 新しい要素のデータ領域を確保する
80. 新しく確保したデータ領域にデータを代入する
81. pNextにこれまでtopがさしていた内容pNextをいれる
82. リストの先頭アドレスであるpNodeをかえす

108. 最初の要素のtopにpListを代入する
112~114. 要素のデータにアクセスし、idが一致した場合はその場所をかえす
116. pListが次の要素を指すようにする
119. idが一致するデータがない場合は-1をかえす
