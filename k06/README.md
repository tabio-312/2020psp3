...
74: int型の変数を定義
76~80: 動的計画法で使用するテーブルを初期化する
82: メニューの数の分繰り返す
83: 所有金額よりもメニューの値段のほうが高い場合、テーブルの状態を引き継ぐ
87: 所有金額よりもメニューの値段のほうが安い場合、所有金額が1000円になるまで繰り返す
88~93: メニューを入れ替える場合と入れ替えない場合のカロリーを比較し、大きいほうの値をテーブルに入れる
95: 最大取得可能カロリーを出力する
